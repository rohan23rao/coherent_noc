...
#(
  ...
  for (genvar t = 0; t < int'(NUM_TILES); t++) begin : gen_tile
    l1_cache u_l1 (
      ...
      .vn0_valid_o (l1_vn0_valid[t]), .vn0_ready_i (l1_vn0_ready[t]),
      .vn0_msg_o   (l1_vn0_msg[t]),
      ...
      .vn2_valid_o (l1_vn2o_valid[t]), .vn2_ready_i (l1_vn2o_ready[t]),
      .vn2_msg_o   (l1_vn2o_msg[t]),
      .dbg_set_i (dbg_set_i),
    ...
    dir_ctrl #(.BANK_ID (t), .ENABLE_E (ENABLE_E)) u_dir (
      ...
      .vn1_valid_o (d_vn1_valid[t]), .vn1_ready_i (d_vn1_ready[t]),
      .vn1_msg_o   (d_vn1_msg[t]),
