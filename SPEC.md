...
Address decode, from LSB: `[4:0]` block offset, `[6:5]` home bank ID, `[12:7]` L1 index, `[31:7]` L1 tag. Putting the bank ID immediately above the offset interleaves consecutive lines across banks; document the alternative (bank bits above the index) and why it was rejected.
